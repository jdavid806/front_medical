...
$tabs = [
  ...
  ['icono' => 'fas fa-microscope', 'titulo' => 'Laboratorio', 'texto' => 'Revisa todos los exámenes de laboratorio ordenados a este paciente', 'url' => 'verExamenes?patient_id=' . $_GET['id']],
