...
$tabs = [
  ...
  ['icono' => 'file-circle-plus', 'titulo' => 'Ordenes médicas', 'texto' => 'Revisa todos los exámenes clínicos recetados a este paciente', 'url' => 'verExamenes?patient_id=' . $_GET['id']],
  ['icono' => 'fas fa-microscope', 'titulo' => 'Laboratorio', 'texto' => 'Revisa todos los exámenes de laboratorio ordenados a este paciente', 'url' => 'verOrdenesExamenes?patient_id=' . $_GET['id']],
