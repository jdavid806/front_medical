                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="filterDropdown">
                                    ...
                                    <li><a class="dropdown-item" href="#">Para hoy</a></li>
                                    <li><a class="dropdown-item" href="#">Prioritarios</a></li>
                ...
                <div class="order-details p-4 mb-4">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6">
                            <div class="card h-100">
                                <div class="card-body">
                                    <h6 class="card-title">Detalles de Pago</h6>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="verification-box">
                                        ...
                                        <div class="text-muted small">Verificada por: Carlos Méndez - 27/02/2025 14:20
                                        </div>
                                    </div>
                                </div>
                            </div>
