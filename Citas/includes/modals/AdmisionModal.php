                ...
                <div class="card theme-wizard mb-5" data-theme-wizard="data-theme-wizard">
                                            ...
                                            <div class="row g-3 mb-3">
                                                <div class="col-sm-6">
                                                    <div class="mb-2 mb-sm-0">
                                                        ...
                                                        <input class="form-control" type="text" name="countryPatient" id="countryPatient" required="required">
                                                    </div>
                                                </div>
                                                <!-- <div class="col-sm-6">
                                        <div class="mb-2 mb-sm-0">
                                            ...
                                            <input class="form-control" type="text" name="deparmentPatient" id="deparmentPatient" required="required">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="mb-2">
                                                        <label class="form-label text-body" for="cityPatient">Ciudad</label>
                                                        <input class="form-control" type="text" name="cityPatient" id="cityPatient" required="required">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row g-3 mb-3">
                                            ...
                                            <div class="row g-3 mb-3">
                                                <div class="col-sm-6">
                                                    <div class="mb-2 mb-sm-0">
                                                        ...
                                                        <input class="form-control" type="text" name="bloodTypePatient" placeholder="Tipo de sangre" id="bloodTypePatient" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="mb-2">
                    ...
                    <div class="card-footer border-top-0" data-wizard-footer="data-wizard-footer">
                        <div class="d-flex pager wizard list-inline mb-0"><button class="d-none btn btn-link ps-0" type="button" data-wizard-prev-btn="data-wizard-prev-btn"><svg class="svg-inline--fa fa-chevron-left me-1" data-fa-transform="shrink-3" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="chevron-left" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" data-fa-i2svg="" style="transform-origin: 0.3125em 0.5em;">
                            ...
                            <div class="flex-1 text-end"><button class="btn btn-primary px-6 px-sm-6" type="submit" id="next_step" data-wizard-next-btn="data-wizard-next-btn" (change)="nextStep()" )>Siguiente<svg class="svg-inline--fa fa-chevron-right ms-1" data-fa-transform="shrink-3" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="chevron-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" data-fa-i2svg="" style="transform-origin: 0.3125em 0.5em;">
                                        <g transform="translate(160 256)">
                                            <g transform="translate(0, 0)  scale(0.8125, 0.8125)  rotate(0 0 0)">
        ...
        try {
            ...
            if (admission && admission.patient && admission.patient.companions && admission.user_availability && admission.appointment_date && admission.appointment_time) {
                ...
                if (typeScheme && attentionType && typeScheme2 && attentionType2 && category) {
                    ...
                    attentionType2.textContent = admission.attention_type;
