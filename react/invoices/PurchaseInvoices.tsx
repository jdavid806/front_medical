...
export const PurchaseInvoices = () => {
    ...
    const aplicarFiltros = () => {
        ...
        if (filtros.identificacion) {
            result = result.filter((factura) =>
                factura.identificacion?.toString().toLowerCase().includes(filtros.identificacion.toLowerCase())
            );
        }
    ...
    <div>
      <table class="invoice-header">
        <tr>
          <td><h3 class="invoice-title">Factura de compra #${invoice.numeroFactura
                }</h3></td>
        ...
        <tbody>
          ${invoice.detalles
            ...
            <tr>
              ...
              <td class="table-cell">${detail.description || "Sin descripción"
                            }</td>
                    ...
                    onSubmit={async (data) => {
                        try {
                            ...
                            showToast(
                                "success",
                                "Éxito",
                                `Nota ${data.type === "credit" ? "Crédito" : "Débito"
