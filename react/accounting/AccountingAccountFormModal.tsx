...
export const AccountingAccountFormModal: React.FC<AccountingAccountFormModalProps> = forwardRef((props, ref) => {
    ...
    const getFormErrorMessage = (name: keyof AccountingAccountFormModalInputs) => {
                ...
                <div className="p-fluid grid formgrid">
                    <div className="field col-12 mb-3">
                        <small className="text-muted">
                            Creando una subcuenta de nivel {selectedAccount ? getNextLevel(selectedAccount.level) : ""} para la cuenta {selectedAccount?.account_name}
                        </small>
                    </div>
