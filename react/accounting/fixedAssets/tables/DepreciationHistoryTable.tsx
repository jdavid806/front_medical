...
export const DepreciationHistoryTable = () => {
    ...
    return [
      {
        ...
        changePercentage:
          (product.purchase_price && product.purchase_price > 0)
            ? (((product.sale_price || 0) - product.purchase_price) / product.purchase_price) * 100
            : 0,
  ...
  const formatProductToMaintenance = (product: any): MaintenanceRecord[] => {
    return [
      {
        id: product.id.toString(),
        assetId: product.id.toString(),
          ...
          <div className="col-12 mt-3">
            ...
            <div className="flex flex-column">
              <div className="flex justify-content-between mb-2">
                ...
                >
                  {netChange > 0 ? "+" : ""}
                  {formatCurrency(netChange)} ({(netPercentage || 0).toFixed(2)}%)
                </span>
              </div>
              <ProgressBar
