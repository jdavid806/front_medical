import { CreateEntitiesDTO, UpdateEntitiesDTO } from "../interfaces/entitiesDTO"
import { EntitiesFormInputs } from "../interfaces/entitiesForm"

export const EntitiesapperCreate = (data: EntitiesFormInputs): CreateEntitiesDTO => {
    return {
...
export const TaxMapperUpdate = (data: EntitiesFormInputs): UpdateEntitiesDTO => {
    return {
        name: data.name,
        document_type: data.document_type,
