            ...
            <div className="container-fluid mt-4">
                <div className="row">
                    <div className="col-12">
                        <Card title="Configuración General del Sistema" className="text-center shadow-sm">
                            <div className="p-5">
                        ...
                        {hasSavedProgress && parsedConfig && (
                            <div className="alert alert-info m-3 mb-0">
                                <small>
                                    ...
                                    Progreso restaurado: Continuando desde <strong>{parsedConfig.current_step}</strong> (Módulo {(parsedConfig.step_index ?? 0) + 1})
                                </small>
                                <Button
                                    icon="pi pi-times"
