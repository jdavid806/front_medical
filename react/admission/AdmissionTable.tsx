...
export const AdmissionTable: React.FC<AdmissionTableProps> = ({
  ...
  const [patientSearch, debouncedPatientSearch, setPatientSearch] = useDebounce<
    string | null
  >(null, 500);
  ...
  const columns: CustomPRTableColumnProps[] = [
    ...
    { header: "Codigo de factura", field: "invoiceCode" },
    { header: "Id", field: "invoiceId" },
    { header: "Productos", field: "products" },
    {
      field: "status",
      header: "Estado",
          ...
          <TableActionsWrapper>
            <li>
              <a
                ...
                href="#"
                onClick={() =>
                  openUpdateAuthorizationModal(data.originalItem.id)
                }
              >
              ...
              <a
                ...
                onClick={async () => {
                  ...
                  await generateInvoice(
                    data.originalItem.appointment_id,
                    false
                  );
                }}
              >
            ...
            {data.originalItem.document_minio_id && (
              <li>
                <a
                  ...
                  href="#"
                  onClick={() =>
                    seeDocument(data.originalItem.document_minio_id)
                  }
                >
                  <div className="d-flex gap-2 align-items-center">
                    <i
            ...
            <RequestCancellationTableAction
              onTrigger={() =>
                onCancelItem && onCancelItem(data.originalItem.id)
              }
            />
          </TableActionsWrapper>
        </>
