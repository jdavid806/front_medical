...
export const AverageBySpecialist: React.FC<any> = ({
  data,
  mainNode,
  dateRange,
}) => {
    ...
    >
      ...
      <div className="print-container">
        ...
        >
          ...
          >
            Reporte Agendamiento - {mainNode.full_name}
          </h1>
          ...
          <tbody>
            {data.map((item: any, index: any) => (
              <tr key={index}>
                ...
                >
                  {item.appointment?.patient?.full_name.toLowerCase() ?? ""}
                </td>
                <td
                  style={{
                    padding: "10px 8px",
                ...
                >
                  {item.appointment?.appointment_date + ", " + item.appointment?.appointment_time}
                </td>
                <td
                  style={{
                    padding: "10px 8px",
                ...
                >
                  {item.consultation_duration ?? "00:00:00"}
                </td>
                <td
                  style={{
                    padding: "10px 8px",
