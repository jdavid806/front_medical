            ...
            <div class="pb-9">
                ...
                <div class="row gy-5">
                    ...
                    <div class="col-12 col-xxl-8">
                        <ul class="nav nav-underline fs-9" id="myTab" role="tablist">
                            <li class="nav-item"><a class="nav-link active" id="doctors-tab" data-bs-toggle="tab" href="#tab-doctors" role="tab" aria-controls="tab-doctors" aria-selected="true">Procedimientos</a></li>
                            <li class="nav-item"><a class="nav-link" id="precios-entidad-tab" data-bs-toggle="tab" href="#tab-precios-entidad" role="tab" aria-controls="tab-precios-entidad" aria-selected="true">Entidades</a></li>
                            <li class="nav-item"><a class="nav-link" id="conteo-entidad-tab" data-bs-toggle="tab" href="#tab-conteo-entidad" role="tab" aria-controls="tab-conteo-entidad" aria-selected="true">Precios - conteo</a></li>
                            <li class="nav-item"><a class="nav-link" id="consultas-tab" data-bs-toggle="tab" href="#tab-consultas" role="tab" aria-controls="tab-consultas" aria-selected="true">Consultas</a></li>
                        </ul>

                        <div class="col-12 col-xxl-4 tab-content mt-3" id="myTabContent">
                            <div class="tab-pane fade show active" id="tab-doctors" role="tabpanel" aria-labelledby="doctors-tab">
                            ...
                            <div class="tab-pane fade" id="tab-precios-entidad" role="tabpanel" aria-labelledby="precios-entidad-tab">
                                <div class="border-top border-translucent">
                                    <div id="purchasersSellersTable" data-list='{"valueNames":["deals_name","deal_owner","account_name","stage","amount"],"page":10,"pagination":true}'>
                                        <div class="table-responsive scrollbar mx-n1 px-1">
                                            <table class="table table-sm fs-9 leads-table-precios-entidad">
                                                <thead>
                            ...
                            <div class="tab-pane fade" id="tab-conteo-entidad" role="tabpanel" aria-labelledby="conteo-entidad-tab">
                                <div class="border-top border-translucent">
                                    <div id="purchasersSellersTable" data-list='{"valueNames":["deals_name","deal_owner","account_name","stage","amount"],"page":10,"pagination":true}'>
                                        <div class="table-responsive scrollbar mx-n1 px-1">
                                            <table class="table table-sm fs-9 leads-table-conteo-entidad">
                                                <thead>
                            ...
                            <div class="tab-pane fade" id="tab-consultas" role="tabpanel" aria-labelledby="consultas-tab">
                                <div class="border-top border-translucent">
                                    <div id="purchasersSellersTable" data-list='{"valueNames":["deals_name","deal_owner","account_name","stage","amount"],"page":10,"pagination":true}'>
                                        <div class="table-responsive scrollbar mx-n1 px-1">
                                            <table class="table table-sm fs-9 leads-table-consultas">
                                                <thead>
...
<script type="module">
    ...
    async function obtenerDatos(filterParams = {}) {
        ...
        await generarTablaProcedimientosMedicos(data);
        await generarTablaMedicosEntidades(data);
        await generarTablaConteoEntidadesMedicos(data);
        await generarTablaCitasProfesionales(data);
    }

    function generarTablaProcedimientosMedicos(data) {
        ...
        headerRow.innerHTML = '<th>Procedimiento</th>';

        Array.from(doctors).forEach(doctor => {
            headerRow.innerHTML += `<th>${doctor}</th>`;
        });
        ...
        // Llenar filas con datos de procedimientos
        Array.from(procedures).forEach(proc => {
            const row = document.createElement('tr');
            row.innerHTML = `<td>${proc}</td>`;
            ...
            Array.from(doctors).forEach(doctor => {
                ...
                rowTotal += total;
                row.innerHTML += `<td>$${total.toLocaleString('es-CO')}</td>`;
            });

            row.innerHTML += `<td>$${rowTotal.toLocaleString('es-CO')}</td>`;
            tbody.appendChild(row);
        });

        // Agregar fila de totales final
        ...
        Array.from(doctors).forEach(doctor => {
            ...
            grandTotal += total;
            totalRow.innerHTML += `<td><strong>$${total.toLocaleString('es-CO')}</strong></td>`;
        });

        totalRow.innerHTML += `<td><strong>$${grandTotal.toLocaleString('es-CO')}</strong></td>`;
        tbody.appendChild(totalRow);

        table.appendChild(tbody);
    }

    function generarTablaMedicosEntidades(data) {
        ...
        // Generar estructura de la tabla
        const table = document.querySelector('.leads-table-precios-entidad');
        table.innerHTML = '';

        // Crear headers
        const thead = document.createElement('thead');
        const headerRow = document.createElement('tr');
        headerRow.innerHTML = '<th>Médico</th>';

        Array.from(entities).forEach(entity => {
            headerRow.innerHTML += `<th>${entity}</th>`;
        });
        ...
        // Llenar filas con datos de médicos
        Array.from(doctors).forEach(doctor => {
            const row = document.createElement('tr');
            row.innerHTML = `<td>${doctor}</td>`;
    ...
    function generarTablaConteoEntidadesMedicos(data) {
        ...
        data.forEach(entry => {
            const entity = entry.insurance.name;
            const doctor = entry.billing_doctor;
            const procedureCount = entry.billed_procedure.length; // Contar cantidad de procedimientos
        ...
        // Generar estructura de la tabla
        const table = document.querySelector('.leads-table-conteo-entidad');
        table.innerHTML = '';

        // Crear headers
        const thead = document.createElement('thead');
        const headerRow = document.createElement('tr');
        headerRow.innerHTML = '<th>Entidad</th>';
        ...
        // Llenar filas con datos de entidades
        Array.from(entities).forEach(entity => {
            const row = document.createElement('tr');
            row.innerHTML = `<td>${entity}</td>`;
            ...
            Array.from(doctors).forEach(doctor => {
                ...
                rowTotal += count;
                row.innerHTML += `<td>${count.toLocaleString('es-CO')}</td>`;
            });
    ...
    function generarTablaCitasProfesionales(data) {
        ...
        // Generar estructura de la tabla
        const table = document.querySelector('.leads-table-consultas');
        table.innerHTML = '';

        // Crear headers
        const thead = document.createElement('thead');
        const headerRow = document.createElement('tr');
        headerRow.innerHTML = '<th>Profesional</th>';
        ...
        // Llenar filas con datos de profesionales
        Array.from(doctors).forEach(doctor => {
            const row = document.createElement('tr');
            row.innerHTML = `<td>${doctor}</td>`;
