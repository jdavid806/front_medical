...
<body>
    ...
    <script>
        ...
        document.getElementById("exportExcel").addEventListener('click', function() {
            ...
            XLSX.writeFile(workbook, "patientsTable.xlsx");
        });
        ...
        function jsonToXml(jsonData) {
            ...
            let xmlContent = "<pacientes>\n";

            jsonData.forEach(paciente => {
                xmlContent += "  <paciente>\n";
                for (let key in paciente) {
                    xmlContent += `    <${key}>${paciente[key]}</${key}>\n`;
                }
                xmlContent += "  </paciente>\n";
            });

            xmlContent += "</pacientes>";
        ...
        document.getElementById("exportPDF").addEventListener("click", function(e) {
            ...
            fetch('Reportes/generate_pdf.php', {
                ...
                .then((blob) => {
                    ...
                    link.href = url;
                    link.download = 'reporte_pacientes.pdf'; // Nombre del archivo
